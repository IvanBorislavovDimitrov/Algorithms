...
public class CyclesInGraph {
    ...
    private static void addEdge(List<Pair<String, String>> cycle, String start, String end) {
        cycle.add(new Pair<>(start, end));
    }

    private static void removeEdge(List<Pair<String, String>> cycle, String start, String end) {
        cycle.removeIf(p -> p.getKey().equals(start) && p.getValue().equals(end));
    }

    private static boolean isEdgeFree(List<Pair<String, String>> cycle, String start, String end) {
